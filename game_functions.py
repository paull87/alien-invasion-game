# game_functions.py - Stores the functions for Alien Invasion.
import sys, pygame
...
def check_events(ai_settings, stats, play_button, screen, ship, aliens,
                 bullets):
...
def ship_hit(ai_settings, stats, screen, ship, aliens, bullets):
    """Respond to shit being hit by alien."""
    if stats.ships_left > 0:
        ...
        # Create a new fleet and and center the ship.
        create_fleet(ai_settings, screen, ship, aliens)
        ship.center_ship()
